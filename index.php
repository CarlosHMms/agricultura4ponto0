...
<head>
    ...
    <!-- Css da página 1 -->
    <link rel="stylesheet" href=css/style.css <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<body>
    ...
    <div id="div_central">
        ...
        while ($linha = mysqli_fetch_array($resultado)) {
            ...
            $nome = $linha['nome'];
            $id_central = $linha['id_central'];

        ?>
            <table border="1" class="tabela">
                <tr>
                    <td colspan="2" width="150"> <?php echo $nome; ?> </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td class="tdval"><?php echo $sensor1; ?></td>
                </tr>
                <tr>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo" viewBox="0 0 16 16">
                    ...
                    <td class="tdval"><?php echo $sensor2; ?></td>
                </tr>
                <tr>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo" viewBox="0 0 16 16">
                    ...
                    <td class="tdval"><?php echo $sensor3; ?></td>
                </tr>
                <tr>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo" viewBox="0 0 16 16">
                    ...
                    <td class="tdval"><?php echo $sensor4; ?></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td class="tdval"><?php echo $umidade;  ?></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td class="tdval"><?php echo $temperatura;  ?></td>
                </tr>
                <form action="sensordados.php?" method="GET">
                    <tr>
                        <td>Data Inicio</td>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="hidden" name="sensor" value="<?php echo $id_central; ?>">
                            <button class="buttonTable" type="submit">INFORMAÇÕES DETALHADAS</button>
